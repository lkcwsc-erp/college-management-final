    ...
    <div className="dashboard-layout">
      ...
      <main className="dashboard-main">
        ...
        <div className="dashboard-content">
          <div style={{
            background: '#fff3e0', padding: '20px', borderRadius: '12px',
            marginBottom: '20px', borderLeft: '5px solid #f57c00'
          }}>
          ...
          <div className="dash-cards">
            <div className="dash-card blue">
              ...
              <div><h3>0</h3><p>Upcoming Exams</p></div>
            </div>
            <div className="dash-card green">
              <div className="dash-card-icon">✅</div>
              <div><h3>0</h3><p>Marks Entered</p></div>
            </div>
            <div className="dash-card orange">
              <div className="dash-card-icon">📄</div>
              <div><h3>0</h3><p>Results Generated</p></div>
            </div>
            <div className="dash-card red">
              <div className="dash-card-icon">⏳</div>
              <div><h3>0</h3><p>Pending Tasks</p></div>
            </div>
          </div>
          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px'}}>
            <div className="event-card" style={{cursor: 'pointer'}}>
              <span className="notice-tag">Plan</span>
              <h4>📅 Create Timetable</h4>
              <p>Schedule upcoming exams</p>
            </div>
            <div className="event-card" style={{cursor: 'pointer'}}>
