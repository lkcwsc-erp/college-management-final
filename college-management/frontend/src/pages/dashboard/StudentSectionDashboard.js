...
const printTC = (adm) => {
  ...
  <div class="page">
    ...
    <div class="rows">
      ...
      <div class="row"><span class="rnum">5.</span><span class="rlabel">Nationality</span><span class="rcolon">:</span><span class="rval"><input type="text" value="Indian" style="min-width:120px"/></span></div>
