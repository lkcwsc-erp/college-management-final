...
const printBonafide = (adm) => {
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    /* Body */
    .body{padding:10px 20px 6px;font-size:14px;line-height:1.75;text-align:justify}
    ...
    <div class="body">
      ...
      <p> She is studying in <span class="ul" style="min-width:280px">&nbsp;${courseFull||'__________________________________'}&nbsp;</span> Course of this College.</p>
      ...
      <p> To the best of my knowledge and belief, her conduct and moral character are <strong>good</strong>.
