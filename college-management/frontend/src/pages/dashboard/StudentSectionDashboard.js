...
const printTC = (adm) => {
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    <div style="border-bottom:3px double #1a237e;padding-bottom:14px;margin-bottom:16px;display:flex;align-items:center;gap:16px">
      <img src="${COLLEGE_LOGO}" style="width:72px;height:72px;object-fit:contain;flex-shrink:0" />
      <div style="flex:1;text-align:center">
        <div style="font-size:10px;color:#555;letter-spacing:0.5px">${COLLEGE_TRUST_DOC}</div>
        <div style="font-size:18px;font-weight:bold;color:#1a237e;margin:2px 0;line-height:1.2">${COLLEGE_NAME_DOC}</div>
        <div style="font-size:10.5px;color:#333;margin-bottom:2px">${COLLEGE_SUBTITLE_DOC}</div>
        <div style="font-size:10px;color:#555">${COLLEGE_ADDRESS_DOC}</div>
        <div style="font-size:10px;color:#555">${COLLEGE_CONTACT_DOC}</div>
      </div>
      <img src="${COLLEGE_LOGO}" style="width:72px;height:72px;object-fit:contain;flex-shrink:0" />
