...
const printBonafide = (adm) => {
  ...
  const dobYYYY  = dobObj ? dobObj.getFullYear()                          : '________';
  ...
  const name      = adm.applicantName || '________________________________';
  const father    = adm.fatherName    || '________________________________';
  const courseStr = (adm.courseType||'__________________') + (adm.preferredSubject?' ('+adm.preferredSubject+')':'');
  const studentId = adm.studentId  || '____________________';
  const prn       = adm.prnNumber  || '____________________';
  const erpId     = 'ERP' + certNo;
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .page{background:white;width:700px;border:2px solid #000;padding:0;box-shadow:0 4px 20px rgba(0,0,0,.15)}
    /* Header */
    .hdr{display:flex;align-items:center;gap:10px;padding:10px 16px;border-bottom:2px solid #000}
    .hlogo{width:80px;height:80px;object-fit:contain;flex-shrink:0}
    .htxt{flex:1;text-align:center}
    .h1{font-size:12px;font-weight:bold;letter-spacing:1px;text-transform:uppercase}
    .h2{font-size:11px}
    .h3{font-size:18px;font-weight:900;text-transform:uppercase;line-height:1.3;margin:3px 0}
    .h4{font-size:11px}
    /* Title */
    .title-section{text-align:center;padding:10px 16px 6px;border-bottom:1px solid #000}
    .title{font-size:16px;font-weight:bold;letter-spacing:4px;text-decoration:underline;text-underline-offset:4px}
    /* Meta row */
    .meta{display:grid;grid-template-columns:1fr 1fr;gap:4px 16px;padding:8px 20px;border-bottom:1px solid #ccc;font-size:12px}
    .mrow{display:flex;gap:4px}
    .ml{font-weight:600;white-space:nowrap}
    .mv{border-bottom:1px solid #000;flex:1;min-width:120px;font-weight:bold}
    /* Body */
    .body{padding:14px 20px 8px;font-size:13.5px;line-height:2.2;text-align:justify}
    ...
    /* Footer */
    .place{padding:6px 20px 0;font-size:12px}
    .foot{display:flex;justify-content:space-between;align-items:flex-end;padding:10px 20px 12px}
    .seal{text-align:center;font-size:11px;color:#444}
    .principal{text-align:right;font-size:13px;font-weight:bold}
    /* ERP */
    .erp{border-top:1px dashed #aaa;padding:5px 20px;font-size:9.5px;color:#666;display:flex;justify-content:space-between}
    @media print{body{background:white;padding:0}.page{box-shadow:none;border:2px solid #000}}
  </style></head><body><div class="page">

    <div class="hdr">
      <img src="data:image/jpeg;base64," class="hlogo"/>
      <div class="htxt">
        ...
        <div class="h4">Lecture Colony, Gangakhed, Dist. Parbhani – 431514</div>
      </div>
    </div>
    ...
    <div class="meta">
      ...
      <div class="mrow"><span class="ml">PRN No.:</span><span class="mv">&nbsp;${prn}</span></div>
    </div>

    <div class="body">
      <p>
        This is to certify that Ms. <span class="ul">&nbsp;${name}&nbsp;</span>
        D/o <span class="ul">&nbsp;${father}&nbsp;</span> is a bonafide student of
        Late Kalpana Chawla Women's Senior College, Gangakhed.
      </p>
      <p>
        She is studying in <span class="ul" style="min-width:220px">&nbsp;${courseStr}&nbsp;</span> Class / Course during the
        Academic Year <span class="ul" style="min-width:90px">&nbsp;${acadYear}&nbsp;</span>.
      </p>
      <p>
    ...
    <div class="place">Place: Gangakhed</div>

    <div class="foot">
      <div class="seal">
        <div style="height:36px"></div>
        <div>Seal of the College</div>
      </div>
      <div class="principal">
        <div style="height:36px"></div>
        <div>PRINCIPAL</div>
    ...
    <div class="erp">
      <span>ERP Verification ID: <strong>${erpId}</strong></span>
