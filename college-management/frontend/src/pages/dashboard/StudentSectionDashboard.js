...
const printIDCard = (adm) => {
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    /* Header */
    .hdr{background:#fff;padding:10px 10px 8px;text-align:center;border-bottom:3px solid #1a237e}
    .logo{width:60px;height:60px;object-fit:contain;border-radius:50%;border:2px solid #1a237e}
    .sanstha{font-size:7.5px;color:#555;margin-top:4px;font-style:italic}
    .college{font-size:11px;font-weight:900;color:#1a237e;margin:3px 0 2px;line-height:1.3}
    ...
    /* Photo */
    .photowrap{background:linear-gradient(180deg,#e8eaf6 0%,#fff 100%);padding:14px 0 10px;text-align:center}
    .photobox{width:80px;height:95px;border:2px solid #1a237e;margin:0 auto 8px;overflow:hidden;background:#c5cae9;display:flex;align-items:center;justify-content:center;border-radius:3px}
    ...
    .lbl{font-size:9px;font-weight:700;color:#555;width:58px;flex-shrink:0}
  ...
  <div class="card">
    ...
    <div class="photowrap">
      <div class="photobox">
        ${adm.studentPhoto ? `<img src="${adm.studentPhoto}" alt="photo"/>` : '<div style="font-size:38px;padding-top:22px;text-align:center">👩</div>'}
      </div>
