...
const printTC = (adm) => {
  ...
  <div class="page">
    ...
    <!-- Register / TC no -->
    <div class="regrow">
      <span><span class="reglabel">Register No. : </span><span class="regval">${adm.studentId||adm.prnNumber||""}</span></span>
      <span><span class="reglabel">T.C. No. : </span><span class="regval">TC${String(new Date().getFullYear()).slice(-2)}-${(adm.studentId||adm.prnNumber||Date.now().toString()).toString().slice(-5)}</span></span>
    </div>
    ...
    <div class="rows">
      ...
      <div class="row"><span class="rnum">6.</span><span class="rlabel">Date of Birth</span><span class="rcolon">:</span><span class="rval"><input type="text" value="${dobStr}" style="min-width:120px"/></span></div>
      <div class="row"><span class="rnum">7.</span><span class="rlabel">(In Words)</span><span class="rcolon">:</span><span class="rval"><input type="text" value="${dobWords}" style="width:100%"/></span></div>
